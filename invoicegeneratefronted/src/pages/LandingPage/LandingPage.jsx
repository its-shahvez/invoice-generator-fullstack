                ...
                <div className="card h-100 shadow-sm border-0 text-center flex-fill">
                    <div className="card-img-top-container d-flex align-items-center justify-content-center p-4 bg-primary-soft">
                        <img
                            ...
                            onError={() => { e.target.onerror = null; e.target.src='https://placehold.co/150x150/E0E0E0/000000?text=Error'}}
                        />
                    </div>
                    <div className="card-body p-4">
                        <h5 className="card-title fw-bold mb-2 fs-5">Enter Details</h5>
                        <p className="card-text text-muted small">
                            Quickly fill in your clients information, item descriptions, quantities, and prices. Our intuitive form makes i
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div className="row align-items-center gy-4 mt-5">
            ...
            <div className="col-md-6">
                ...
                <ul className="list-unstyled text-muted">
                    ...
                    <li className="mb-2"><i className="bi bi-check-circle-fill text-primary me-2"></i>One click to Save, Download and Delete.</li>
                </ul>
            </div>
        </div>
        {/* Feature 4 */}
 ...
 <footer className="py-5 bg-dark text-white-50">
    <div className="container text-center">
        ...
        <p className="mt-2">
            ...
            <a href="#" className="text-white-50 me-2"> <X/></a>
